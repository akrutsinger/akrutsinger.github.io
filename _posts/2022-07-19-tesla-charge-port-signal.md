---
layout: post
title: "A guided approach to reverse engineering the Tesla charge port remote signal"
...
![Congure I/O device](/assets/images/tesla-charge-port-signal/configure_gqrx_io_dev.png)

Now that we've configured the I/O device, we need to set the correct frequency. Based on the FCC ID ([2AEIM-1023049](https://apps.fcc.gov/oetcf/eas/reports/ViewExhibitReport.cfm?mode=Exhibits&RequestTimeout=500&calledFromFrame=N&application_id=W3grfILGc%2B%2FGI0LoK45snA%3D%3D&fcc_id=2AEIM-1023049)) of the Tesla charge port remote, we know it operates at 315MHz. We don't want that to be our center frequency, though. We'll always get a "loud" signal at the hardware center frequency caused by DC voltage on the radio. To get past this, we'll technically listen to 500KHz (NOTE: 500KHz is arbitrary. Just pick something that offsets the signal a bit from the SDR's hardware center frequency) above or below our target 315MHz. A frequency slightly offset from 315MHz will move the "loud" signal away from the target, making it easier/possible to analyze.

If you still want to analyze the signal, but cannot capture it yourself, feel free to grab a copy from [here](/assets/files/iq/tesla_315MHz_2Msps_OOK.cf32)

![315MHz signal](/assets/images/tesla-charge-port-signal/315mhz_signal.png)
...
![I/Q recording](/assets/images/tesla-charge-port-signal/iq_recording.png)
...
![Open I/Q file](/assets/images/tesla-charge-port-signal/open_file.png)
...
![Amplitude plot](/assets/images/tesla-charge-port-signal/amplitude_plot.png)
...
![Threshold plot](/assets/images/tesla-charge-port-signal/threshold_plot.png)
...
![Cursors](/assets/images/tesla-charge-port-signal/enable_cursors.png)
...
![Increase symbol count](/assets/images/tesla-charge-port-signal/increase_symbols.png)
...
![All symbols](/assets/images/tesla-charge-port-signal/all_symbols.png)
...
![Extracted symbols](/assets/images/tesla-charge-port-signal/extracted_symbols.png)
...
![Search SoF](/assets/images/tesla-charge-port-signal/search_sofs.png)
...
![42 byte signal](/assets/images/tesla-charge-port-signal/42_bytes.png)
